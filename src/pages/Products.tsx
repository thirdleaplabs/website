          ...
          <div className="browser-frame">
            ...
            <div className="cognisense-ui grid min-h-[420px] grid-cols-[1.55fr_.75fr] gap-2 p-3">
              <div className="grid grid-rows-[1.2fr_.8fr] gap-2">
                <div className="ui-card relative overflow-hidden p-4"><div className="absolute inset-0 opacity-15 brand-grid" /><div className="relative flex h-full flex-col justify-between"><div className="flex items-center justify-between mono text-[8px] uppercase text-[#BFC0C0]"><span>Live facility view</span><span className="text-[#1DA1F2]">12 events</span></div><div className="grid grid-cols-3 gap-3">{[72, 45, 61].map((height, index) => <div key={`${height}-${index}`} className="flex h-24 items-end border border-[#BFC0C0]/10 p-2"><span className="w-full bg-[#1DA1F2]/40" style={{ height: `${height}%` }} /></div>)}</div></div></div>
