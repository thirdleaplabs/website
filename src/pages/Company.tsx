          ...
          <div className="grid gap-4 lg:grid-cols-[1.35fr_.65fr]">
            <section className="panel grid gap-7 p-7 md:grid-cols-[190px_1fr] md:p-8">
              ...
              <div className="flex flex-col">
                ...
                <p className="copy-md mt-6">Software engineering and technology leader with experience spanning embedded systems, automotive software, platform architecture, cloud applications and product development. Through Third Leap Labs, he builds applied-AI and data-intelligence products including EyeWitX and WhaleScanner.</p>
            ...
            <aside className="panel p-7 md:p-8">
              <div className="flex items-center justify-between border-b border-[#2D3142]/35 pb-4"><p className="mono text-[10px] uppercase tracking-[.07em]">Operational Data</p><Boxes className="h-4 w-4 text-[#4F5D75]" /></div>
              <dl className="mt-7 space-y-6">
                ...
                <div className="border-l-2 border-[#2D3142] pl-4"><dt className="mono text-[9px] uppercase tracking-[.08em] text-[#4F5D75]">Operating perspective</dt><dd className="mt-1 text-[13px]">International</dd></div>
                <div className="border-l-2 border-[#2D3142] pl-4"><dt className="mono text-[9px] uppercase tracking-[.08em] text-[#4F5D75]">Regional strategy</dt><dd className="mt-1 text-[13px]">Exploring Qatar / GCC</dd></div>
              </dl>
              <div className="mt-8 flex min-h-[120px] items-center justify-center border border-[#2D3142]/15 bg-[#2D3142] px-6 text-center">
                <p className="mono text-[9px] uppercase leading-5 tracking-[.07em] text-[#BFC0C0]">US entity<br />European operating perspective<br />GCC expansion</p>
              </div>
            </aside>
          </div>
