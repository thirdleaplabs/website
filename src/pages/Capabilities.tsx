...
const technologyStack = ['PyTorch', 'TensorRT', 'OpenCV', 'ONNX', 'Linux', 'Docker', 'Kubernetes', 'Azure', 'React', 'TypeScript', 'Solana'];
      ...
      <section className="bg-white py-20 lg:py-24">
        <div className="page-shell panel grid gap-10 p-8 md:p-12 lg:grid-cols-[1fr_.9fr] lg:items-center">
          ...
          <div className="relative flex min-h-[260px] items-center justify-center overflow-hidden border border-[#2D3142]/15 bg-[#F2F1F2]">
            <img src={infrastructureImage} alt="Data infrastructure and edge systems" loading="lazy" className="absolute inset-0 h-full w-full object-cover grayscale contrast-[1.12] brightness-[.64]" />
            <div className="absolute inset-0 bg-[#111827]/24" />
            <div className="relative text-center text-white/90">
              <Cpu className="mx-auto h-10 w-10" strokeWidth={1.2} />
              <p className="mono mt-5 text-[10px] tracking-[.06em]">model → runtime → platform</p>
            </div>
          </div>
        </div>
      </section>
